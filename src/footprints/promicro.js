module.exports = {
  ...
  body: p => `
    ...
    (module ProMicro (layer F.Cu) (tedit 5B307E4C)
      ...
      (pad 13 thru_hole circle (at -13.97 7.62 ${p.rot}) (size 1.7526 1.7526) (drill 1.0922)    (layers *.Cu *.SilkS *.Mask) ${p.net.P1})
      ...
      (pad 1  thru_hole rect   (at -13.97 -7.62 0) (size 1.7526 1.7526) (drill 1.0922)          (layers *.Cu *.SilkS *.Mask) ${p.net.RAW})
